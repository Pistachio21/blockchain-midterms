...
export namespace PostLikedEvent {
  export type InputTuple = [id: BigNumberish, liker: AddressLike];
  export type OutputTuple = [id: bigint, liker: string];
  export interface OutputObject {
    id: bigint;
    liker: string;
  }
...
export interface TipPost extends BaseContract {
  ...
  createPost: TypedContractMethod<
    [_imageUrl: string, _caption: string],
    [void],
    "nonpayable"
  >;
  ...
  likePost: TypedContractMethod<[_id: BigNumberish], [void], "payable">;
